# Android lyrics view with RTC media

## Overview

Display synchronized lyrics in an Android RTC media experience for karaoke, music, or live audio use cases.

Use this recipe when you want a working reference for Android UI, lyrics rendering, RTC audio, synchronization.

Repository: [AgoraIO-Community/LyricsView](https://github.com/AgoraIO-Community/LyricsView)
...
```text
You are working in `AgoraIO-Community/LyricsView`. Add or adapt this sample so a developer can run the android lyrics view with rtc media end to end with Agora RTC.
